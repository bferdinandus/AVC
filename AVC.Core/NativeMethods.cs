...
namespace AVC.Core
{
    public class NativeMethods
    {
        ...
        {
            if (fileName.Contains(",") && int.TryParse(fileName.Split(',')[1], out index)) {
            ...
            if (File.Exists(fileName)) {
                ...
                IntPtr r = SHGetFileInfo(fileName, 0, ref shInfo, (uint) Marshal.SizeOf(shInfo), SHGFI_ICON | (smallIcon ? SHGFI_SMALLICON : SHGFI_LARGEICON));
